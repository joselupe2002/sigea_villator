...
<html lang="es">
	...
	<div id="laspreguntas" class="hidden" ></div> 

	<div class="widget-box widget-color-purple" id="principal">
			  <div class="widget-header widget-header-small" style="padding:0px;">
			      <div class="row" >	
				         
						<div id="lasencuestas" class="col-sm-3" >
						</div>                    				
						<div id="lascarreras" class="col-sm-2">
						</div> 	
						<div id="laspersonas" class="col-sm-3">
						</div>    
						<div id="losfiltros" class="col-sm-1">
						</div>   
						<div id="losvalores" class="col-sm-1">
						</div>      
									 
					
						<div class="col-sm-1" style="padding-top:14px;">
						    <button title="Ver Información de su encuesta" onclick="cargarInformacion();" class="btn btn-white btn-info btn-round" value="Agregar"> 
								<i class="ace-icon green fa fa-book bigger-100"></i><span class="btn-small"> Encuestas</span>            
							</button>																					 									
						</div>
		            </div> 
		      </div>
              ...
              <div class="widget-body">
				   <div class="widget-main">
				       ...
				       <div class="row">							   
					       <div id="informacion" class="col-sm-12 graph sigeaPrin" style="overflow-x: auto; height:350px;" >    
						   </div>
                       </div>
...
<script src="enc_resxalum.js?v=<?php echo date('YmdHis'); ?>"></script>
