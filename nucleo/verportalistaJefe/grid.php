        	 ...
        	 $("#cuerpo").empty();
      	     $("#tabHorarios").append("<tbody id=\"cuerpo\">"); 
       	     jQuery.each(JSON.parse(data), function(clave, valor) { 	
		          ...
		          $("#row"+valor.MATRICULA).append("<td style=\"text-align:center\"><a title=\"Ver Archivo de Evidencia Encuadre\" onclick=\"previewAdjunto('"+valor.RUTAENCU+"');\">"+
	                                                    " <img width=\"30px\" height=\"30px\" id=\""+valor.MATRICULA+"ENCUADRE\" "+
	                                                           "src=\""+ladefault+"\" width=\"50px\" height=\"50px\"></a></td>");

		          $("#row"+valor.MATRICULA).append("<td style=\"text-align:center\"><a title=\"Ver Archivo de Evidencia Diuagn&oacute;stica\" onclick=\"previewAdjunto('"+valor.RUTADIAG+"');\">"+
                          " <img width=\"30px\" height=\"30px\" id=\""+valor.MATRICULA+"DIAGNOSTICA\" "+
                                 "src=\""+ladefault+"\" width=\"30px\" height=\"30px\"></a></td>");

		          $("#row"+valor.MATRICULA).append("<td style=\"text-align:center\"><a title=\"Ver Archivo de Evidencia de Producto\" onclick=\"previewAdjunto('"+valor.RUTAEP+"');\">"+
                          " <img width=\"30px\" height=\"30px\" id=\""+valor.MATRICULA+"EP\" "+
                                 "src=\""+ladefault+"\" width=\"30px\" height=\"30px\"></a></td>");

		          $("#row"+valor.MATRICULA).append("<td style=\"text-align:center\"><a title=\"Ver Archivo de Evidencia de desempe&ntilde;o\" onclick=\"previewAdjunto('"+valor.RUTAED+"');\">"+
                          " <img width=\"30px\" height=\"30px\" id=\""+valor.MATRICULA+"ED\" "+
                                 "src=\""+ladefault+"\" width=\"30px\" height=\"30px\"></a></td>");
                  
		          $("#row"+valor.MATRICULA).append("<td style=\"text-align:center\"><a title=\"Ver Archivo de Evidencia de Conocimiento\" onclick=\"previewAdjunto('"+valor.RUTAEC+"');\">"+
                          " <img width=\"30px\" height=\"30px\" id=\""+valor.MATRICULA+"EC\" "+
                                 "src=\""+ladefault+"\" width=\"30px\" height=\"30px\"></a></td>");

		          $("#row"+valor.MATRICULA).append("<td style=\"text-align:center\"><a title=\"Ver Archivo de Evidencia Actitud\" onclick=\"previewAdjunto('"+valor.RUTAEA+"');\">"+
