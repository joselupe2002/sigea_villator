...
jQuery.each(grid_data, function(clave, valor) { 
	...
	img1="<a onclick=\"previewAdjunto('../../adjuntos/docgen/"+valor.DOCGEN_RUTA+"');\" target=\"_blank\" > <img  id=\"img1\" src=\"../../imagenes/menu/ayuda1.png\"  style=\"width:60px; height:60px;\" /></a>";
	if (valor.DOCGEN_RUTA=="../../imagenes/menu/default.png") {img1="";}
	img2="<a onclick=\"previewAdjunto('"+valor.ENLACEEXT+"');\"  target=\"_blank\"> <img  id=\"img1\" src=\"../../imagenes/menu/ayuda1.png\"  style=\"width:60px; height:60px;\" /></a>";
