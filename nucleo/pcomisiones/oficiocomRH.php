...
<?php session_start(); if (($_SESSION['inicio']==1)) {
	...
	class PDF extends FPDF {
		...
		$elpsto=utf8_decode("SUBDIRECTOR DE ADMINISTRACIÓN Y PLANEACIÓN");
		...
		$pdf->MultiCell(0,5,utf8_decode('Por medio de la presente, le informó a usted que el(los) Profesor(es): '),0,'J', false);
		$pdf->ln();
