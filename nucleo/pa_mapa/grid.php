			           ...
			           losdatos=JSON.parse(data);  
			        	...
			        	jQuery.each(losdatos, function(clave, valor) { 
                         ...
                         cad="<div id=\""+valor.CICL_MATERIA+"\""+estiloPadre+">"+                                     
		                            ...
		                            "<div style=\"position:absolute; top:18px; left:80px;\" ><a id=\""+valor.CICL_MATERIA+"_ENL\"  onclick=\"previewAdjunto('"+valor.RUTA+"');\"><img id=\""+valor.CICL_MATERIA+"_PDF\" title=\"Ver Manual de Asignatura\" src=\"../../imagenes/menu/pdf.png\" width=\"15px\" height=\"15px\" /></a></div>"+		                      
		                          "</div>";
		                   //console.log(cad);
                        $("#mihoja").append(cad);
