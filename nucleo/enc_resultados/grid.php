	...
	<div class="widget-box widget-color-purple" id="principal">
			  <div class="widget-header widget-header-small" style="padding:0px;">
			      <div class="row" >	
						...
						<div id="laspreguntas" class="col-sm-3">
						</div>       
						...
						<div class="col-sm-3" style="padding-top:14px;">
							...
							<button title="Ver todas las materias y profesores porcentaje de evaluaciones realizadas" onclick="verTablas();" class="btn btn-white btn-info btn-round" value="Agregar"> 
								<i class="ace-icon pink fa fa-table bigger-100"></i><span class="btn-small"> Tablas</span>            
							</button>					
              ...
              <div class="widget-body">
				   <div class="widget-main">
				       ...
				       <div class="row">							   
					       <div id="informacion" class="col-sm-12 graph" style="overflow-x: auto; height:350px;" >    
						   </div>
                       </div>
...
<script src="enc_resultados.js?v=<?php echo date('YmdHis'); ?>"></script>
