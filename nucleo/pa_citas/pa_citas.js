					...
					success: function(data){	
						...
						$.ajax({
							...
							success: function(data){ 
								...
								correoPersona(usuario,"<html><span style=\"color:green;\"><b>Te confirmamos tu cita: </b></span>"+mensaje,"ITSP: CONFIRMACIÓN DE CITA "+dataCita[0]["FECHA"]);			
								correoPersona(dataCita[0]["RESPONSABLE"], "<html><span style=\"color:green;\"><b>Se agendo una cita: </b></span>"+mensaje,"ITSP: CONFIRMACIÓN DE CITA "+dataCita[0]["FECHA"]);	
	...
	if (confirm("¿Desea cancelar esta cita?")) {				
		...
		$.ajax({
			...
			success: function(data){ 
				...
				correoPersona(dataCita[0]["SOLICITANTE"],"<html><span style=\"color:green;\"><b>Te confirmamos <span style=\"color:red;\"> CANCELACIÓN </span> de tu cita: </b></span>"+mensaje,"ITSP: CANCELACIÓN DE CITA "+dataCita[0]["FECHA"]);			
				correoPersona(dataCita[0]["RESPONSABLE"], "<html><span style=\"color:green;\"><b>Se <span style=\"color:red;\"> CANCELO </span> una cita: </b></span>"+mensaje,"ITSP: CANCELACIÓN DE CITA "+dataCita[0]["FECHA"]);	
