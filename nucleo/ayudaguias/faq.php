...
<html lang="es">
	...
	<div class="widget-box widget-color-red" id="principalfaq">

			  <div class="widget-header widget-header-small">
			      <div class="row" >	
						
						<div class="col-sm-8" style="padding-left:20px;padding-top:10px;">                            
                            <span class="badge badge-danger bigger-140"><i class="fa fa-info"></i></span>
                            <span class="fontRobotoB"> Preguntas Frecuentes </span>																													 									
						</div>
...
<script src="faq.js?v=<?php echo date('YmdHis'); ?>"></script>
