...
<html lang="es">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo $nivel; ?>css/menu/demo.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo $nivel; ?>css/menu/style2.css" />
	...
	<body id="grid_guia"  style="background-color: white; width:98%;" class="sigeaPrin2">
	<div class="row">
	
		<button type="button" onclick="faq('<?php echo $_GET["id"]; ?>');" 
			class="btn btn-white btn-warning pull-left" style="margin-left:30px; height:30px;">
			<i class="fa fa-question red"></i> Preguntas Frecuentes
	    </button>

	    <button type="button" onclick="bajarInfo('miguia','guia.png');" 
			class="btn btn-white btn-success pull-right" style="height:30px;"><i class="fa fa-download green"></i> Descargar
	    </button>
		<select title="Formato" class="form-controls pull-right" id="selTipo" onchange="cambioTipo('TIPO');"></select>
		<select title="Color" class="form-controls pull-right" id="selColor" onchange="cambioTipo('COLOR');"></select>
	</div>


	<div class="alert sigeaPrin" id="miguia">			
...
<script src="<?php echo $nivel; ?>assets/js/tree.min.js"></script>
...
<script src="guia.js?v=<?php echo date('YmdHis'); ?>"></script>
...
<script type="text/javascript">
	...
	var elid="<?php echo $_GET["id"]; ?>";
	var elpadre="<?php echo $_GET["pad"]; ?>";
	var tit="<?php echo $_GET["tit"]; ?>";
	var tipo="<?php echo $_GET["tipo"]; ?>";
	var permisos="<?php echo $_SESSION['permisos']?>";
	var color="<?php echo $_GET["colores"]; ?>";
