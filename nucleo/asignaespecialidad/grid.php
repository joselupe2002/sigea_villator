			  ...
			  <div class="widget-header widget-header-small" style="padding:0px;">
			      <div class="row" >	
						...
						<div class="col-sm-3" style="padding-top:14px;">
                            <button title="Buscar todos los alumnos sin especialidad" onclick="cargarInformacion('N');" class="btn btn-white btn-info btn-round" value="Agregar"> 
								<i class="ace-icon red fa fa-user bigger-140"></i><span class="btn-small"></span>            
							</button>
						    <button title="Buscar todos los alumnos de ese ciclo" onclick="cargarInformacion('S');" class="btn btn-white btn-info btn-round" value="Agregar"> 
								<i class="ace-icon green fa fa-group bigger-140"></i><span class="btn-small"></span>            
							</button>
							<button title="Herramienta de exportación" onclick="convertirDataTable('tabInformacion');" 
...
<script src="asignaespecialidad.js?v=<?php echo date('YmdHis'); ?>"></script>
