...
/*===================================================================================================================*/
			...
			{		
                ...
                " where MATERIA=MATE_CLAVE  and ifnull(MATE_TIPO,'')  NOT IN ('T','RP','I') AND EVALDOC='S' AND IFNULL(a.BASE,'0')='0' and a.CICLO='".$_GET["ciclo"]."'  and PROFESOR='".$_GET["profesor"]."'". " ORDER BY SEMESTRE,MATERIAD";
