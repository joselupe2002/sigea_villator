...
<html lang="es">
	...
	<div class="widget-box widget-color-brown" id="principal">
			      ...
			      <div class="row" >	
						...
						<div class="col-sm-2" style="padding-top:14px;">
							...
							<div class="checkbox" style="padding:0px; margin: 0px;">
								...
								<span  class="lbl text-success"> Atendidos</span>										
							</div>
							<div class="checkbox" style="padding:0px; margin: 0px;">
								<label>
								<input id="nocotejados" type="checkbox" class="ace ace-switch ace-switch-6" />
								<span class="lbl  text-danger"> No Cotejados</span>										
							</div>
...
<script src="liberaingles.js?v=<?php echo date('YmdHis'); ?>"></script>
