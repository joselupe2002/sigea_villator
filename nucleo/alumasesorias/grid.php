...
/*=========================================================================*/
	...
	function cargarAsesores(){
	    elsql="select * from vedescarga i, pempleados where DESC_PROFESOR=EMPL_NUMERO AND i.DESC_CICLO=getciclo() AND i.DESC_ACTIVIDAD IN ('002','004') ORDER BY DESC_PROFESORD";
			...
			$.ajax({
				...
				success: function(data){		
					...
					correoalProf(prof, "<html>El alumno <span style=\"color:green\"><b>"+usuario+" "+nombreuser+
								...
								"Lugar: "+"<a href=\""+lugar+"\">"+lugar+"</a>","ITSP: SOLICITUD DE ASESORIAS "+usuario+" "+nombreuser);			
					...
					correoalAlum(usuario, "<html>"+usuario+" "+nombreuser+" Te confirmamos que tu asesoria quedo agendada <span style=\"color:green\"><b>"+
								...
								"<br> Lugar: "+"<a href=\""+lugar+"\">"+lugar+"</a>","ITSP: CONFIRMACION DE ASESORIAS "+usuario+" "+nombreuser);			
			...
			$.ajax({
				...
				success: function(data){		                                	                      
					if (!(data.substring(0,1)=="0"))	
							...
							,"ITSP: CANCELACION DE ASESORIAS "+usuario+" "+nombreuser);			
