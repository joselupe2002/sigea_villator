			  ...
			  <div class="widget-header widget-header-small" style="padding:0px;">
			      <div class="row" >	
						...
						<div class="col-sm-3" style="padding-top:14px;">
						    <button title="Ver Resultados por sección" onclick="CargaGenerales();" class="btn btn-white btn-info btn-round" value="Agregar"> 
				       ...
				       <div class="row">							   
					       <div id="informacion" class="col-sm-12" style="overflow-x: auto; height:350px;" >   
								<div class="row">
											...
											<div class="col-sm-7 infobox-container">
												<div class="infobox infobox-green">
													...
													<div class="infobox-data">
														<span class="infobox-data-number" id="presentando">0</span>
														<div class="infobox-content">Presentando</div>
													</div>                
												</div>
												...
												<div class="infobox infobox-blue">
													...
													<div class="infobox-data">
														<span class="infobox-data-number" id="terminaron">0</span>
														<div class="infobox-content">Terminaron</div>
													</div>
										...
										<div class="col-sm-8">
											<span class="text-success lead"><i class="ace-icon fa fa-keyboard-o bigger-120 blue"></i> <strong> Aspirantes Presentando</strong></span>
											<div  id="lascarrerasDiv"></div>
											<div class="space-6"></div>
											<span class="text-primary lead"><i class="ace-icon fa fa-check bigger-120 green"></i> <strong> Aspirantes Finalizarón</strong></span>
											<div  id="lascarrerasDivFin"></div>
										</div>
								</div> 
								

                       		</div><!-- div de informacion-->	
                    </div>
			   </div>
		</div>
...
<script src="linestadistica.js?v=<?php echo date('YmdHis'); ?>"></script>
