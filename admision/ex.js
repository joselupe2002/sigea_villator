			...
			jQuery.each(JSON.parse(data), function(clave, valor) { 
				   stElim="display:none; cursor:pointer;";
					...
					"                   onchange=\"subirPDFDriveSaveAsp_local('file_"+valor.CLAVE+"','docAspira','pdf_"+
												  ...
												  "',' DOCUMENTO  "+valor.DOCUMENTO+" ','adjaspirantes','alta','"+valor.CLAVE+"_"+usuario+"_"+elciclo+"','"+valor.CLAVE+"_"+usuario+"_"+elciclo+"');\">"+
					...
					"                      'adjaspirantes','alta','"+valor.CLAVE+"_"+usuario+"_"+elciclo+"','PDF');\"></i> "+              				                        
					"      </div> ";
